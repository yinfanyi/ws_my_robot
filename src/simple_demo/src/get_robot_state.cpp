...
int main(int argc, char** argv)
{
  ...
  auto node = rclcpp::Node::make_shared("get_robot_state", node_options);
  ...
  const moveit::core::JointModelGroup* joint_model_group = kinematic_model->getJointModelGroup("my_arm1");
  ...
  const Eigen::Isometry3d& end_effector_state = robot_state->getGlobalLinkTransform("link4");
